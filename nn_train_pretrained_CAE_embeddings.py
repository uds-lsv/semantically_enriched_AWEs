...
config_args['pretrained_model_state_file'] = os.path.join(
...
#  dataloader ...
word_dataset = WordPairDataset(speech_df, word_featurizer, is_CAE=True)
...
word_encoder.load_state_dict(torch.load(config_args['pretrained_model_state_file']))
