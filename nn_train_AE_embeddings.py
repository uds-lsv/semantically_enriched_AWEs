...
#word_encoder.load_state_dict(torch.load(config_args['model_save_dir'] + '19102021_13_30_24_AWEs_1cnn_3rnn_512D_AE_TF02_dr02_CZE_FBANK_100.pth'))
...
for batch_index, eval_batch_dict in enumerate(batch_generator):
    ...
    _, acoustic_embs = word_encoder(
        eval_batch_dict['acoustic_word_view_1'],
        eval_batch_dict['acoustic_word_view_2']
    )
