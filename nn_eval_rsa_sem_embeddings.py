...
for l in label_set:
	...
	try:
		...
		category2vectors[l] = defaultdict(list)
		...
		for batch_index, batch_dict in enumerate(batch_generator):
			...
			semantic_embs, acoustic_embs = word_encoder( #rnn2, rnn3,
		...
		for w, vec in zip(word_orth_list, acoustic_vectors):
		    category2vectors[l][w].append(vec)
...
file_name = f"/nethome/babdullah/awe_workplace/PGE_sem_dict_2.{target_l}.pickle"

with open(file_name, 'wb') as handle:
    pickle.dump(category2vectors, handle, protocol=pickle.HIGHEST_PROTOCOL)

# for l in label_set:
#
#     corr = feature_space_linear_cka(lang2mat_1[target_l], lang2mat_1[l]); print(target_l, l, corr) #rbf_cka
...
# for l in label_set:
#
#     corr = feature_space_linear_cka(lang2mat_2[target_l], lang2mat_2[l]); print(target_l, l, corr)


# print()
# for l in label_set:
#
#     corr = feature_space_linear_cka(lang2mat_3[target_l], lang2mat_3[l]); print(target_l, l, corr)
#
#
# print()
# for l in label_set:
#
#     corr = feature_space_linear_cka(lang2mat_4[target_l], lang2mat_4[l]); print(target_l, l, corr)
#
#
# print()
# for l in label_set:
#
#     corr = feature_space_linear_cka(lang2mat_5[target_l], lang2mat_5[l]); print(target_l, l, corr)
